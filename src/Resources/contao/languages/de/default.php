...
$GLOBALS['TL_LANG']['MSC']['user_application']['participant']['option']['label']['limit_per_day_reached'] = '%s (Pro-Tag-Limit erreicht)';
$GLOBALS['TL_LANG']['MSC']['user_application']['participant']['option']['label']['limit_reached'] = '%s (maximale Anzahl Anmeldungen erreicht)';
