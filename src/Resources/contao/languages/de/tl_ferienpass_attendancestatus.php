...
$GLOBALS['TL_LANG']['tl_ferienpass_attendancestatus']['type'][1] = 'Bitte wählen Sie den Typ des Status aus.';
$GLOBALS['TL_LANG']['tl_ferienpass_attendancestatus']['title'][0] = 'Titel';
$GLOBALS['TL_LANG']['tl_ferienpass_attendancestatus']['title'][1] = 'Bitte geben Sie den Titel ein, der im Frontend ausgegeben werden soll ein.';
$GLOBALS['TL_LANG']['tl_ferienpass_attendancestatus']['notification_new'][0] = 'Benachrichtigung';
...
$GLOBALS['TL_LANG']['tl_ferienpass_attendancestatus']['show'][1] = 'Details vom Status ID %s anzeigen';
