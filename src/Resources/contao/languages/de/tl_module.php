 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['editFormTpl'][0] = 'Formular-Template';
$GLOBALS['TL_LANG']['tl_module']['editFormTpl'][1] = 'Hier können Sie das Formular-Template überschreiben.';
$GLOBALS['TL_LANG']['tl_module']['enableVariants'][0] = 'Varianten aktivieren';
